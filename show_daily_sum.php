...
// 쿼리 실행        
$db_data = "SELECT * FROM daily_product_total_Tbl";  //daily_product_data_Tbl 에서 모든 열의 데이터를 가져오는 쿼리
...
// 테이블 출력
echo "<label><a href='http://localhost/show_daily_sum.php' >기간: </a></label>";
...
echo "<label><a href='http://localhost/show_daily_sum.php' >&nbsp&nbsp&nbsp&nbsp모델: </a></label>";   // 드롭 다운 버튼의 라벨
